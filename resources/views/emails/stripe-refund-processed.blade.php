    ...
    <div class="wrap">
        ...
        <div class="body">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    <div class="label">Stripe Refund ID</div>
                    <div class="value">{{ $payment->stripe_refund_id ?? 'N/A' }}</div>
                </div>
                <div class="info-item">
        ...
        <div class="footer">
            <p>
                ...
                Email: <a href="mailto:contact@carrental.ma">contact@carrental.ma</a>
            </p>
