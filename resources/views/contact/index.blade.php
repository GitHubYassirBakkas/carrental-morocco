                ...
                @if($contact['phone'])
                    <div class="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-3xl border border-gray-800 p-6 flex items-start gap-5 hover:border-[#C89D66]/40 transition">
                        ...
                        <div>
                            ...
                            <a href="tel:{{ preg_replace('/[^\d+]/', '', $contact['phone']) }}" class="text-gray-400 hover:text-[#C89D66] transition text-sm">{{ $contact['phone'] }}</a>
                        </div>
                    </div>
                @endif
                ...
                @if($contact['email'])
                    <div class="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-3xl border border-gray-800 p-6 flex items-start gap-5 hover:border-[#C89D66]/40 transition">
                        ...
                        <div>
                            ...
                            <a href="mailto:{{ $contact['email'] }}" class="text-gray-400 hover:text-[#C89D66] transition text-sm">{{ $contact['email'] }}</a>
                        </div>
                    </div>
                @endif
                ...
                @if($contact['address'])
                    <div class="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-3xl border border-gray-800 p-6 flex items-start gap-5 hover:border-[#C89D66]/40 transition">
                        ...
                        <div>
                            ...
                            <p class="text-gray-400 text-sm">{{ $contact['address'] }}</p>
                        </div>
                    </div>
                @endif

                {{-- Working Hours --}}
                @if($primaryLocation?->opening_time && $primaryLocation?->closing_time)
                    <div class="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-3xl border border-gray-800 p-6">
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                <span class="text-gray-400">{{ $primaryLocation->city ?: $primaryLocation->name }}</span>
                                <span class="text-white font-medium">{{ substr($primaryLocation->opening_time, 0, 5) }} - {{ substr($primaryLocation->closing_time, 0, 5) }}</span>
                            </div>
                        </div>
                    </div>
                @endif
