        ...
        <div class="bp-card">
            ...
            <div class="bp-car-body">
                ...
                <div class="bp-car-info">
                    ...
                    <p class="bp-car-meta">{{ $car->year }} • {{ ui_car_type($car->type) }}</p>

                    <div class="bp-car-specs">
                        <div class="bp-spec-pill">
                            <span>{{ __('messages.transmission') }}</span>
                            <strong>{{ ui_transmission($car->transmission) }}</strong>
                        </div>
                        <div class="bp-spec-pill">
                            <span>{{ __('messages.fuel_type') }}</span>
                            <strong>{{ ui_fuel_type($car->fuel_type) }}</strong>
                        </div>
                        <div class="bp-spec-pill">
            ...
            @if(($preview['pickup_location_id'] ?? null) != ($preview['dropoff_location_id'] ?? null))
                <div class="bp-diff-notice">
                    ...
                    <div>
                        ...
                        <p>{{ __('messages.different_dropoff_desc') }} <span>{{ number_format($preview['dropoff_fee'] ?? 0, 0) }} MAD</span></p>
                    </div>
                </div>
            @endif
        </div>
