...
<div class="min-h-screen bg-[#0a0e1a] p-8">
    ...
    <div class="mb-8 flex items-center gap-3">
        ...
        <div>
            <h1 class="text-4xl font-bold text-white">Add New Location</h1>
            <p class="text-gray-400">Create a new pickup/dropoff location</p>
        </div>
    </div>
            ...
            <form action="{{ route('admin.locations.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" 
                                   ...
                                   placeholder="e.g., Casablanca Airport, Downtown Office"
                                   required>
                            @error('name')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="email" 
                                   ...
                                   value="{{ old('email') }}"
                                   class="w-full px-4 py-3 bg-[#0a0e1a] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                   placeholder="location@carrental.ma">
                            @error('email')
                                <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="mb-8">
                    ...
                    <textarea name="notes" 
                              rows="3"
                              class="w-full px-4 py-3 bg-[#0a0e1a] border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="Any special instructions or notes about this location...">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
