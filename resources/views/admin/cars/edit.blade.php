...
<div class="cf">
    ...
    <div class="cf-header">
        ...
        <div class="cf-header-actions">
           <a href="{{ route('cars.show', $car) }}" class="cf-view-btn" target="_blank">
            ...
            <div class="cf-right">
                ...
                <div class="cf-section">
                    ...
                    <div class="cf-dropzone {{ $car->image ? 'cf-dropzone--sm' : '' }}" id="mainDrop">
                        <input type="file" name="image" accept=".jpg,.jpeg,.png,.webp,image/jpeg,image/png,image/webp" id="mainImg">
